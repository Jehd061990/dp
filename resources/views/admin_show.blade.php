        ...
        <div class="row">
            <table class="table">
                ...
                <tr>
                    ...
                    <td>{{$a -> last_name}}</td>
                    <td>{{$a -> email}}</td>
                    <td><a href="/admin/{{$a -> user_id}}" class="btn btn-primary">View</a></td>
                    <td>
                        <a data-bs-toggle="modal" data-bs-target="#delete_{{$a -> user_id}}" class="btn btn-danger">Delete</a>
                    </td>
                    <!-- delete modal -->
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">Once this action is taken, it cannot be undone.
                                    <div class="modal-footer">
                                        ...
                                        <form action="/admin/{{$a -> user_id}}" method="POST">
                                            @csrf
                                            @method('DELETE')
