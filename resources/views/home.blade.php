        ...
        {{-- <div class="row dwelling_car">
            <div class="col-lg-12">
                    ...
                    <div id="dwelling-hero" class="carousel slide" data-bs-ride="carousel" data-bs-interval="6000">
                        ...
                        <button class="carousel-control-prev" type="button" data-bs-target="#dwelling-hero" data-bs-slide="prev" style="margin-left: -5%">
                            <span class="carousel-control-prev-icon"></span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#dwelling-hero" data-bs-slide="next" style="margin-right: -5%">
