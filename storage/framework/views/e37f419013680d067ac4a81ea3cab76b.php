    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end me-3 text-center navbar-margin-top" id="navbarTogglerDemo03">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('/') ? 'active' : ''); ?>" href="/" id="nav_names">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('product') ? 'active' : ''); ?>" href="/product" id="nav_names">Products</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('about') ? 'active' : ''); ?>" href="/about" tabindex="-1" id="nav_names">About</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('FAQ') ? 'active' : ''); ?>" href="/FAQ" tabindex="-1" id="nav_names">FAQ</a>
                </li>
            </ul>
...
</nav><?php /**PATH C:\Users\User\Desktop\bootcamp\capstone\dp\resources\views/layouts/navbar_user.blade.php ENDPATH**/ ?>